defmodule GameOfLifeCore.Matrix5.StateAgent do
  use Agent

  alias GameOfLifeCore.Matrix5.{GolServer, StateAgent}
  ...
  It's done this way cause Elixir likes to manage list instead of Matrix5.
  """
  ...
  @doc """
  Build a 'cell_and_environment' list just for one line of the Matrix5.
  """
