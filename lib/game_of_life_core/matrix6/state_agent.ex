defmodule GameOfLifeCore.Matrix6.StateAgent do
  use Agent

  alias GameOfLifeCore.Matrix6.{GolServer, StateAgent}
  ...
  It's done this way cause Elixir likes to manage list instead of Matrix6.
  """
  ...
  @doc """
  Build a 'cell_and_environment' list just for one line of the Matrix6.
  """
